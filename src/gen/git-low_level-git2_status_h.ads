...
package Git.Low_Level.git2_status_h is
  ...
  --  
   ...
   GIT_STATUS_WT_TYPECHANGE : constant unsigned := 1024;
   GIT_STATUS_WT_RENAMED : constant unsigned := 2048;
   GIT_STATUS_WT_UNREADABLE : constant unsigned := 4096;
   GIT_STATUS_IGNORED : constant unsigned := 16384;
   GIT_STATUS_CONFLICTED : constant unsigned := 32768;  -- /usr/include/git2/status.h:52
  ...
  --  
   ...
   GIT_STATUS_OPT_SORT_CASE_INSENSITIVELY : constant unsigned := 1024;
   GIT_STATUS_OPT_RENAMES_FROM_REWRITES : constant unsigned := 2048;
   GIT_STATUS_OPT_NO_REFRESH : constant unsigned := 4096;
   GIT_STATUS_OPT_UPDATE_INDEX : constant unsigned := 8192;
   GIT_STATUS_OPT_INCLUDE_UNREADABLE : constant unsigned := 16384;
   GIT_STATUS_OPT_INCLUDE_UNREADABLE_AS_UNTRACKED : constant unsigned := 32768;  -- /usr/include/git2/status.h:156
