...
package Git.Low_Level.git2_index_h is
  ...
  --  
   ...
   GIT_INDEX_ENTRY_EXTENDED : constant unsigned := 16384;
   GIT_INDEX_ENTRY_VALID : constant unsigned := 32768;  -- /usr/include/git2/index.h:90
  ...
  --  
   ...
   GIT_INDEX_ENTRY_INTENT_TO_ADD : constant unsigned := 8192;
   GIT_INDEX_ENTRY_SKIP_WORKTREE : constant unsigned := 16384;
   GIT_INDEX_ENTRY_EXTENDED_FLAGS : constant unsigned := 24576;
