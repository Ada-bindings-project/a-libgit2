...
package git.Low_Level.git2_submodule_h is
  ...
  --
   ...
   GIT_SUBMODULE_STATUS_WD_MODIFIED       : constant unsigned := 1_024;
   GIT_SUBMODULE_STATUS_WD_INDEX_MODIFIED : constant unsigned := 2_048;
   GIT_SUBMODULE_STATUS_WD_WD_MODIFIED    : constant unsigned := 4_096;
   GIT_SUBMODULE_STATUS_WD_UNTRACKED      : constant unsigned := 8_192;  -- /usr/include/git2/submodule.h:89
