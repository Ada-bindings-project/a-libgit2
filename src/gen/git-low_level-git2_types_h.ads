...
package git.Low_Level.git2_types_h is
  ...
  --* Valid modes for index and tree entries.
   ...
   GIT_FILEMODE_TREE            : constant unsigned := 16_384;
   GIT_FILEMODE_BLOB            : constant unsigned := 33_188;
   GIT_FILEMODE_BLOB_EXECUTABLE : constant unsigned := 33_261;
   GIT_FILEMODE_LINK            : constant unsigned := 40_960;
   GIT_FILEMODE_COMMIT          : constant unsigned := 57_344;  -- /usr/include/git2/types.h:220
