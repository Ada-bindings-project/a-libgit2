...
package git.Low_Level.git2_checkout_h is
  ...
  --* Recursively checkout submodules if HEAD moved in super repo (NOT IMPLEMENTED)
   ...
   GIT_CHECKOUT_SKIP_UNMERGED                : constant unsigned := 1_024;
   GIT_CHECKOUT_USE_OURS                     : constant unsigned := 2_048;
   GIT_CHECKOUT_USE_THEIRS                   : constant unsigned := 4_096;
   GIT_CHECKOUT_DISABLE_PATHSPEC_MATCH       : constant unsigned := 8_192;
   GIT_CHECKOUT_SKIP_LOCKED_DIRECTORIES      : constant unsigned := 262_144;
   GIT_CHECKOUT_DONT_OVERWRITE_IGNORED       : constant unsigned := 524_288;
   GIT_CHECKOUT_CONFLICT_STYLE_MERGE         : constant unsigned := 1_048_576;
   GIT_CHECKOUT_CONFLICT_STYLE_DIFF3         : constant unsigned := 2_097_152;
   GIT_CHECKOUT_DONT_REMOVE_EXISTING         : constant unsigned := 4_194_304;
   GIT_CHECKOUT_DONT_WRITE_INDEX             : constant unsigned := 8_388_608;
   GIT_CHECKOUT_UPDATE_SUBMODULES            : constant unsigned := 65_536;
   GIT_CHECKOUT_UPDATE_SUBMODULES_IF_CHANGED : constant unsigned := 131_072;  -- /usr/include/git2/checkout.h:189
  ...
  --
   ...
   GIT_CHECKOUT_NOTIFY_ALL       : constant unsigned := 65_535;  -- /usr/include/git2/checkout.h:226
