...
package Git.Low_Level.git2_diff_h is
  ...
  --	  
   ...
   GIT_DIFF_IGNORE_CASE : constant unsigned := 1024;
   GIT_DIFF_INCLUDE_CASECHANGE : constant unsigned := 2048;
   GIT_DIFF_DISABLE_PATHSPEC_MATCH : constant unsigned := 4096;
   GIT_DIFF_SKIP_BINARY_CHECK : constant unsigned := 8192;
   GIT_DIFF_ENABLE_FAST_UNTRACKED_DIRS : constant unsigned := 16384;
   GIT_DIFF_UPDATE_INDEX : constant unsigned := 32768;
   GIT_DIFF_INCLUDE_UNREADABLE : constant unsigned := 65536;
   GIT_DIFF_INCLUDE_UNREADABLE_AS_UNTRACKED : constant unsigned := 131072;
   GIT_DIFF_INDENT_HEURISTIC : constant unsigned := 262144;
   GIT_DIFF_FORCE_TEXT : constant unsigned := 1048576;
   GIT_DIFF_FORCE_BINARY : constant unsigned := 2097152;
   GIT_DIFF_IGNORE_WHITESPACE : constant unsigned := 4194304;
   GIT_DIFF_IGNORE_WHITESPACE_CHANGE : constant unsigned := 8388608;
   GIT_DIFF_IGNORE_WHITESPACE_EOL : constant unsigned := 16777216;
   GIT_DIFF_SHOW_UNTRACKED_CONTENT : constant unsigned := 33554432;
   GIT_DIFF_SHOW_UNMODIFIED : constant unsigned := 67108864;
   GIT_DIFF_PATIENCE : constant unsigned := 268435456;
   GIT_DIFF_MINIMAL : constant unsigned := 536870912;
   GIT_DIFF_SHOW_BINARY : constant unsigned := 1073741824;  -- /usr/include/git2/diff.h:171
  ...
  --	  
   ...
   GIT_DIFF_FIND_IGNORE_WHITESPACE : constant unsigned := 4096;
   GIT_DIFF_FIND_DONT_IGNORE_WHITESPACE : constant unsigned := 8192;
   GIT_DIFF_FIND_EXACT_MATCH_ONLY : constant unsigned := 16384;
   GIT_DIFF_BREAK_REWRITES_FOR_RENAMES_ONLY : constant unsigned := 32768;
   GIT_DIFF_FIND_REMOVE_UNMODIFIED : constant unsigned := 65536;  -- /usr/include/git2/diff.h:696
